...
object Version extends VersionCompanion[Version, ExtendedVersion] with Of[Dot[Dot[Version]]] {
  ...
  override def of(major: Int): Dot[Dot[Version]] = new Dot[Dot[Version]] {
    override def apply(minor: Int) = new Dot[Version] {
      override def apply(patch: Int) = Version(major, minor, patch)
    }
  }
