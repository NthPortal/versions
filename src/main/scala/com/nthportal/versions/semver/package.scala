...
package object semver {
  ...
  def parseSemVer[E, M](
      version: String
  )(implicit ed: ExtensionDef[E], ep: ExtensionParser[E], mp: BuildMetadata.Parser[M]): SemanticVersion[E, M] = {
    try {
      version split '+' match {
        case Array(ver, meta) =>
   ...
   */
  @throws[VersionFormatException]
  def parseSemVerWithoutMetadata[E](
      version: String
  )(implicit ed: ExtensionDef[E], ep: ExtensionParser[E]): v3.ExtendedVersion[E] = {
    try {
   ...
   *         SemVer version
   */
  def parseSemVerAsOption[E, M](version: String)(implicit
      ed: ExtensionDef[E],
      ep: ExtensionParser[E],
      mp: BuildMetadata.Parser[M]
  ): Option[SemanticVersion[E, M]] = {
  ...
  object SemVer {
     ...
     */
    def unapply[E, M](version: String)(implicit
        ed: ExtensionDef[E],
        ep: ExtensionParser[E],
        mp: BuildMetadata.Parser[M]
    ): Option[(v3.Version, E, Option[M])] = {
  ...
  @inline
  @throws[IllegalArgumentException]
  private def parseExtendedVersion[E](
      version: String
  )(implicit ep: ExtensionParser[E], ed: ExtensionDef[E]): v3.ExtendedVersion[E] = {
    v3.ExtendedVersion.parseVersion(version)(
      ed,
      extension => {
